package com.nabethse.bibliotecamedios;
...
public class HelloApplication extends javafx.application.Application {
    ...
    private static BibliotecaDeMedios bibliotecaDeMedios;
    @Override
    ...
    public static BibliotecaDeMedios getBibliotecaDeMedios() {
        return bibliotecaDeMedios;
    }
